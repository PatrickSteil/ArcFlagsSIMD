...
public:
  ...
  StatisticsCollecter(std::vector<std::string> &metricNames)
      : metricNames(metricNames), counters(metricNames.size(), 0),
        numRounds(0) {};
...
public:
  ...
  FullStatisticsCollecter(std::vector<std::string> &newMetricNames,
      ...
      : metricNames(newMetricNames), phasesNames(newPhasesNames),
        counters(metricNames.size(), 0), timersPerPhase(phasesNames.size()),
        totalTimePerPhase(phasesNames.size(), 0),
        totalCallsPerPhase(phasesNames.size(), 0), numRounds(0) {};
